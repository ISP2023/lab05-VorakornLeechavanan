...
def average(data):
    ...
    :param data: list of numeric values to average. Must not be empty.
...
def variance(data):
    ...
    This is different from the Python library statistics.variance()
    that returns the sample variance, where the sum is divided by (n-1).
